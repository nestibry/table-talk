          ...
          <Row className="form" >
            <Col xs={12} md={6} className="mb-3" >
              ...
              <Form.Group className="mb-3" controlId="formLocationState">
                <Form.Label>Which State Does Your Appetite Hail</Form.Label>
              ...
              <Form.Group className="mb-3" controlId="formPronoun">
                <Form.Label>Please Share Your Pronoun</Form.Label>
            ...
            <Col xs={12} md={6}>
              ...
              <Form.Group className="mb-3" controlId="formProfileStatus">
                <Form.Label>Select a Profile Status</Form.Label>
              ...
              <Form.Group className="mb-3" controlId="formAge">
                <Form.Label>Age is Nothing but a Number</Form.Label>
